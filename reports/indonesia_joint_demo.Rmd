...
# ✅ Adddding validator right after reading CSV
required_cols <- c(
  "asset_id", "asset_value", "daily_revenue",
  "gross_margin", "price_pass_through",
  "insurance_deductible", "insurance_limit"
)

missing <- setdiff(required_cols, names(assets))
if (length(missing)) {
  stop("assets CSV is missing columns: ", paste(missing, collapse = ", "))
}
